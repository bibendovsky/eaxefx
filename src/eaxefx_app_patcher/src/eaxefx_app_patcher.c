...
const unsigned char patch_2_unpatched_bytes_3[] =
{
	0xD9, 0x44, 0x24, 0x10,
	0x8B, 0x8C, 0x24, 0x1C, 0x81, 0x00, 0x00
};

const unsigned char patch_2_patched_bytes_3[] =
{
	0xE9, 0x83, 0x35, 0x25, 0x00,
	0x90,
	0x90,
	0x90,
	0x90,
...
const unsigned char patch_2_unpatched_bytes_4[] =
{
...
const unsigned char patch_2_patched_bytes_4[] =
{
	0xD9, 0x44, 0x24, 0x10,
	0xD9, 0xE8,
	0xDE, 0xD9,
...
const PatchBlock patch_2_block_array[] =
{
...

	{
		patch_2_file_name,
		0x000F720C,
		{patch_2_unpatched_bytes_3, ARRAY_SIZE(patch_2_unpatched_bytes_3)},
		{patch_2_patched_bytes_3, ARRAY_SIZE(patch_2_patched_bytes_3)}
	},

	{
		patch_2_file_name,
		0x0034A794,
		{patch_2_unpatched_bytes_4, ARRAY_SIZE(patch_2_unpatched_bytes_4)},
		{patch_2_patched_bytes_4, ARRAY_SIZE(patch_2_patched_bytes_4)}
	}
};
...
#define patch_7_file_name "BGE.exe"

const unsigned char patch_7_unpatched_bytes_1[] =
{
	0xFF, 0x51, 0x10,
	0x8B, 0x46, 0x04
};

const unsigned char patch_7_patched_bytes_1[] =
{
	0xE9, 0x25, 0x6E, 0x71, 0x00,
	0x90
};

const unsigned char patch_7_unpatched_bytes_2[] =
{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const unsigned char patch_7_patched_bytes_2[] =
{
	0x8B, 0x42, 0x08,
	0x3D, 0x00, 0x00, 0xAA, 0x42,
	0x74, 0x09,
	0x3D, 0x00, 0x00, 0xC8, 0x42,
	0x74, 0x09,
	0xEB, 0x0C,
	0xB8, 0x9A, 0x99, 0x59, 0x3F,
	0xEB, 0x05,
	0xB8, 0x00, 0x00, 0x80, 0x3F,
	0x89, 0x42, 0x08,
	0x8B, 0x42, 0x20,
	0x83, 0xF8, 0x00,
	0x75, 0x05,
	...
	0xFF, 0x51, 0x10,
	0x8B, 0x46, 0x04,
	0xE9, 0x9F, 0x91, 0x8E, 0xFF
};

const PatchBlock patch_7_block_array[] =
{
	{
		patch_7_file_name,
		0x0001FE75,
		{patch_7_unpatched_bytes_1, ARRAY_SIZE(patch_7_unpatched_bytes_1)},
		{patch_7_patched_bytes_1, ARRAY_SIZE(patch_7_patched_bytes_1)}
	},

	{
		patch_7_file_name,
		0x00736C9F,
		{patch_7_unpatched_bytes_2, ARRAY_SIZE(patch_7_unpatched_bytes_2)},
		{patch_7_patched_bytes_2, ARRAY_SIZE(patch_7_patched_bytes_2)}
	}
};

/*-------------------------------------------------------------------------*/

#define patch_8_file_name "BGE.exe"

const unsigned char patch_8_unpatched_bytes_1[] =
{
	0xFF, 0x51, 0x10,
	0x8B, 0x46, 0x04
};

const unsigned char patch_8_patched_bytes_1[] =
{
	0xE9, 0xB1, 0x41, 0x72, 0x00,
	0x90
};

const unsigned char patch_8_unpatched_bytes_2[] =
{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const unsigned char patch_8_patched_bytes_2[] =
{
	0x8B, 0x42, 0x08,
	0x3D, 0x00, 0x00, 0xAA, 0x42,
	0x74, 0x09,
	...
	0xFF, 0x51, 0x10,
	0x8B, 0x46, 0x04,
	0xE9, 0x13, 0xBE, 0x8D, 0xFF
};

const PatchBlock patch_8_block_array[] =
{
	{
		patch_8_file_name,
		0x000455D1,
		{patch_8_unpatched_bytes_1, ARRAY_SIZE(patch_8_unpatched_bytes_1)},
		{patch_8_patched_bytes_1, ARRAY_SIZE(patch_8_patched_bytes_1)}
	},

	{
		patch_8_file_name,
		0x00769787,
		{patch_8_unpatched_bytes_2, ARRAY_SIZE(patch_8_unpatched_bytes_2)},
		{patch_8_patched_bytes_2, ARRAY_SIZE(patch_8_patched_bytes_2)}
	}
};

/*-------------------------------------------------------------------------*/

#define patch_9_file_name "BGE.exe"

const unsigned char patch_9_unpatched_bytes_1[] =
{
	0xFF, 0x51, 0x10,
	0x8B, 0x46, 0x04
};

const unsigned char patch_9_patched_bytes_1[] =
{
	0xE9, 0xC5, 0x7F, 0x71, 0x00,
	0x90
};

const unsigned char patch_9_unpatched_bytes_2[] =
{
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const unsigned char patch_9_patched_bytes_2[] =
{
	0x8B, 0x42, 0x08,
	0x3D, 0x00, 0x00, 0xAA, 0x42,
	0x74, 0x09,
...
const PatchBlock patch_9_block_array[] =
{
	{
		patch_9_file_name,
		0x00020505,
		{patch_9_unpatched_bytes_1, ARRAY_SIZE(patch_9_unpatched_bytes_1)},
		{patch_9_patched_bytes_1, ARRAY_SIZE(patch_9_patched_bytes_1)}
	},

	{
		patch_9_file_name,
		0x007384CF,
		{patch_9_unpatched_bytes_2, ARRAY_SIZE(patch_9_unpatched_bytes_2)},
		{patch_9_patched_bytes_2, ARRAY_SIZE(patch_9_patched_bytes_2)}
	}
};
...
const Patch patch_array[] =
{
	...
	{
		"Beyond Good & Evil (2003) v1.1 (GOG)",
		"Fixes Environment Diffusion and Decay LF Ratio reverb parameters.",
		{patch_7_block_array, ARRAY_SIZE(patch_7_block_array)}
	},

	{
		"Beyond Good & Evil (2003) v1.1 (Ubisoft Connect)",
		"Fixes Environment Diffusion and Decay LF Ratio reverb parameters.",
		{patch_8_block_array, ARRAY_SIZE(patch_8_block_array)}
	},

	{
		"Beyond Good & Evil (2003) v1.1 (Retail)",
		"Fixes Environment Diffusion and Decay LF Ratio reverb parameters.",
		{patch_9_block_array, ARRAY_SIZE(patch_9_block_array)}
	}
};
